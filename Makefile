#############################################################################
# Makefile for building: ras
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  ras.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -o Makefile ras.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -std=c++0x -Wall -W -D_REENTRANT -fPIE -fpermissive $(DEFINES)
...
SOURCES       = circlewidget.cpp \
		getdata.cpp \
		main.cpp \
		window.cpp qrc_res.cpp \
		moc_circlewidget.cpp \
		moc_getdata.cpp \
		moc_getSocket.cpp \
		moc_window.cpp
OBJECTS       = circlewidget.o \
		getdata.o \
		main.o \
		window.o \
		qrc_res.o \
...
Makefile: ras.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/ras1.0.0 || mkdir -p .tmp/ras1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/ras1.0.0/ && $(COPY_FILE) --parents picture/res.qrc .tmp/ras1.0.0/ && $(COPY_FILE) --parents circlewidget.h getdata.h getSocket.h window.h .tmp/ras1.0.0/ && $(COPY_FILE) --parents circlewidget.cpp getdata.cpp main.cpp window.cpp .tmp/ras1.0.0/ && (cd `dirname .tmp/ras1.0.0` && $(TAR) ras1.0.0.tar ras1.0.0 && $(COMPRESS) ras1.0.0.tar) && $(MOVE) `dirname .tmp/ras1.0.0`/ras1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ras1.0.0
...
qrc_res.cpp: picture/res.qrc \
		picture/nonconnection.png \
		picture/emergency.png \
		picture/msg.png \
		picture/normal.png \
		picture/call.png \
		picture/success.png
	/usr/lib/arm-linux-gnueabihf/qt5/bin/rcc -name res picture/res.qrc -o qrc_res.cpp

compiler_moc_header_make_all: moc_circlewidget.cpp moc_getdata.cpp moc_getSocket.cpp moc_window.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_circlewidget.cpp moc_getdata.cpp moc_getSocket.cpp moc_window.cpp
moc_circlewidget.cpp: circlewidget.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/1202/ras -I/home/pi/1202/ras -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include circlewidget.h -o moc_circlewidget.cpp

moc_getdata.cpp: getdata.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/1202/ras -I/home/pi/1202/ras -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include getdata.h -o moc_getdata.cpp

moc_getSocket.cpp: getSocket.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/1202/ras -I/home/pi/1202/ras -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include getSocket.h -o moc_getSocket.cpp

moc_window.cpp: window.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/1202/ras -I/home/pi/1202/ras -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include window.h -o moc_window.cpp
...
getdata.o: getdata.cpp getdata.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o getdata.o getdata.cpp
...
window.o: window.cpp circlewidget.h \
		window.h
...
moc_getdata.o: moc_getdata.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_getdata.o moc_getdata.cpp

moc_getSocket.o: moc_getSocket.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_getSocket.o moc_getSocket.cpp
